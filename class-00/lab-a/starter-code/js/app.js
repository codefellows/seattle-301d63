...
let leftImage = document.getElementById('left');let centerImage = document.getElementById('center');let rightImage = document.getElementById('right');

let allProducts = [];let container = document.getElementById('image_container');
let viewed = [];
let labels = [];
