...
function displayPics(){
  ...
  // Var makes something a global variable while let makes it only a variable within the block scope. Since the console.log was not called within the code block it was undefined and caused an error
  console.log(viewed);
