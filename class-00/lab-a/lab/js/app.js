...
function displayPics(){
  ...
  // After changing the variable declaration to 'let', the variable was not accessible outside of the code block where it was declared. 'Let' is not a global variable outside of a code block.
  console.log(viewed);
